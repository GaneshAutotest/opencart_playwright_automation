...
```ts
  ...
  23 |         await homePage.clickOnMyAccountDrodown();
  24 |         await homePage.clickOnLoginLink();
  25 | 
  ...
  61 |         await homePage.clickOnMyAccountDrodown();
  62 |         await homePage.clickOnLoginLink();
  63 | 

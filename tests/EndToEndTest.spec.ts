...
async function performRegistration(page: Page): Promise<string> {
    ...
    await homePage.clickOnMyAccountDrodown();       // Click "My Account" link
    await homePage.clickOnRegisterLink();        // Click "Register" option

    const registrationPage = new RegistartionPage(page);
